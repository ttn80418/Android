...
public class MainActivity extends Activity {
    ...
    private class GetHttpResponse extends AsyncTask<Void, Void, Void>
    {
        ...
        {
            HttpService httpService = new HttpService("https://tcnr1624.000webhostapp.com/android_mysql_connect/courses.php");
            try
            {
                    ...
                    if(result != null)
                    {
                        ...
                        try {
                            ...
                            for(int i=0; i<jsonArray.length(); i++)
                            {
                                ...
                                college.cources_name = object.getString("Event_Date");
                                college.cources_description = object.getString("Event_Title");
